...
module.exports = (sequelize) => {
  ...
  const User = sequelize.define("User", {
    ...
    username: { 
      ...
      unique: "unique_username"               // No two users can have the same username
    },
    ...
    email: { 
      type: DataTypes.STRING,    // Store as text (up to 255 characters)
      allowNull: false,          // This field is required - cannot be empty
      unique:"unique_email",               // No two users can have the same email
      validate: {
  ...
  indexes: [
    {
      unique: true,
      fields: ["username"],
      name: "unique_username_idx"   // ✅ prevent Sequelize from making username_2, username_3...
    },
    {
      unique: true,
      fields: ["email"],
